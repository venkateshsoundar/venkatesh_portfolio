...
with mid_col:
    st.markdown(
        '<div class="card"><div class="typewriter"><h1>Welcome to my Profile</h1></div><p style="margin-top:20px;">Explore projects below and chat at the end of this column!</p></div>',
        unsafe_allow_html=True
    )
    st.markdown(
