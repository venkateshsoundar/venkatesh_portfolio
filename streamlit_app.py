...
.typewriter h1 { overflow: hidden; border-right: .15em solid #82A3C8; white-space: nowrap; letter-spacing: .15em; animation: typing 3.5s steps(40, end), blink-caret .75s step-end infinite; }
@keyframes typing { from { width: 0; } to { width: 100%; } }
@keyframes blink-caret { from, to { border-color: transparent; } 50% { border-color: #82A3C8; } }
</style>
...
with mid_col:
    ...
    st.markdown(
        "<div class='card'><div class='typewriter'><h1>Welcome to Venkatesh's Portfolio</h1></div><p style='margin-top:20px;'>Explore my work and chat with me on the left.</p></div>",
        unsafe_allow_html=True
    )
    # Projects Showcase as 2-column grid
