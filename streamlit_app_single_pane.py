...
<div class="card hover-zoom">
  ...
  <div class="collapsible-card">
    <div class="collapsible-header" onclick="toggleCardContent(1)">TechInsights Inc, Canada – Software Developer Intern (May 2025 – Present)</div>
    <div class="collapsible-content" id="collapsible-1">
      <ul>
        <li>Developing a scalable Data Lineage framework using AWS services (Glue, Lambda, S3, Athena)...</li>
        <li>Automated ETL workflows to trace data origin...</li>
        <li>Integrated metadata tracking and schema evolution...</li>
        <li>Collaborated with data engineers and stakeholders to deliver dashboards using Power BI and AWS QuickSight.</li>
        <li>Strengthened data integrity and trust with validation checkpoints.</li>
      </ul>
    </div>
  </div>

  <div class="collapsible-card">
    <div class="collapsible-header" onclick="toggleCardContent(2)">Deloitte Consulting India Pvt Ltd – Senior Consultant (Oct 2021 – Aug 2024)</div>
    <div class="collapsible-content" id="collapsible-2">
      <ul>
        <li>Worked as a Functional Analyst for Personal Lines insurance projects...</li>
        <li>Participated in 3 Amigos sessions (QA, BA, Dev)...</li>
        <li>Supported client demos by walkthrough of implemented functionalities...</li>
        <li>Executed integration and configuration functionalities aligned with evolving requirements...</li>
        <li>Developed an automated status dashboard framework...</li>
        <li>Prepared and shared Daily Status Reports with stakeholders...</li>
        <li>Gained hands-on experience with AWS cloud services including EC2, DynamoDB, and S3...</li>
      </ul>
    </div>
  </div>

  <div class="collapsible-card">
    <div class="collapsible-header" onclick="toggleCardContent(3)">Capgemini Technology Services India Pvt Ltd – Consultant (May 2018 – Oct 2021)</div>
    <div class="collapsible-content" id="collapsible-3">
      <ul>
        <li>Conducted end-to-end testing of Guidewire-based Worker Compensation policies...</li>
        <li>Transitioned from QA to a hybrid BA/QA role...</li>
        <li>Created an automation tool that sent real-time failure alerts...</li>
        <li>Participated in agile forums within a team of eight members...</li>
        <li>Provided mentorship and leadership to the data QA team...</li>
      </ul>
    </div>
  </div>

  <div class="collapsible-card">
    <div class="collapsible-header" onclick="toggleCardContent(4)">Cognizant Technology Solutions India Pvt Ltd – Associate (Sep 2013 – May 2018)</div>
    <div class="collapsible-content" id="collapsible-4">
      <ul>
        <li>Joined as a fresher in the Mainframe Testing batch...</li>
        <li>Managed and tracked key project metrics for healthcare initiatives valued at over $2M...</li>
        <li>Led test environment management for continuous testing across healthcare projects...</li>
        <li>Delivered 10+ knowledge transfer sessions...</li>
        <li>Supported healthcare production remediation processes...</li>
      </ul>
    </div>
  </div>
