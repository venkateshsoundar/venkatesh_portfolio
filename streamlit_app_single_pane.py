...
with st.container():
    with st.expander("Tech Insights Inc (May 2025 – Present)", expanded=False):
        st.markdown('<div class="expander-style">', unsafe_allow_html=True)
        st.markdown("""
        <div class="exp-header">
            <img src="https://github.com/venkateshsoundar/venkatesh_portfolio/raw/main/TI.png" />
            <div class="exp-header-text">
                <div class="role">Software Developer Intern</div>
                <div class="company">Tech Insights Inc, Canada</div>
    ...
    with st.expander("Deloitte Consulting India Pvt Ltd (Oct 2021 – Aug 2024)", expanded=False):
        st.markdown('<div class="expander-style">', unsafe_allow_html=True)
        st.markdown("""
        <div class="exp-header">
            <img src="https://github.com/venkateshsoundar/venkatesh_portfolio/raw/main/Deloitte.png" />
            <div class="exp-header-text">
                <div class="role">Senior Consultant</div>
                <div class="company">Deloitte Consulting India Pvt Ltd, India</div>
                <div class="dates">Oct 2021 – Aug 2024</div>
            </div>
        </div>
        """, unsafe_allow_html=True)
        st.markdown("""
    ...
    with st.expander("Capgemini Technology Services India Pvt Ltd (May 2018 – Oct 2021)", expanded=False):
        st.markdown('<div class="expander-style">', unsafe_allow_html=True)
        st.markdown("""
        <div class="exp-header">
            <img src="https://github.com/venkateshsoundar/venkatesh_portfolio/raw/main/Capgemini.png" />
            <div class="exp-header-text">
                <div class="role">Consultant</div>
                <div class="company">Capgemini Technology Services India Pvt Ltd, India</div>
                <div class="dates">May 2018 – Oct 2021</div>
            </div>
        </div>
        """, unsafe_allow_html=True)
        st.markdown("""
    ...
    with st.expander("Cognizant Technology Solutions India Pvt Ltd (Sep 2013 – May 2018)", expanded=False):
        st.markdown('<div class="expander-style">', unsafe_allow_html=True)
        st.markdown("""
        <div class="exp-header">
            <img src="https://github.com/venkateshsoundar/venkatesh_portfolio/raw/main/Cognizant.png" />
            <div class="exp-header-text">
                <div class="role">Associate</div>
                <div class="company">Cognizant Technology Solutions India Pvt Ltd, India</div>
                <div class="dates">Sep 2013 – May 2018</div>
            </div>
        </div>
        """, unsafe_allow_html=True)
        st.markdown("""
